		...
		<div class="container-fluid"><div class="row">
	      ...
	      <%@ include file="/WEB-INF/views/template/incEns/header.jsp"%>
	        <h3 style="">
                        ...
                        Informations sur vous enfants       </h3>
							...
							<td>
								<div class="btn-group">
									...
									<ul class="dropdown-menu dropdown-default pull-right"
										...
										<!-- EDITING LINK -->
										<li>                      <a href='<c:url value="/parent/remarques"><c:param name="id" value="${eleve.id}"/></c:url>' >

										<i class="entypo-menu"></i> affiche remarque
										</a></li>
										<li class="divider"></li>

										<!-- DELETION LINK -->
										<li>                      <a href='<c:url value="/parent/notes/eleve"><c:param name="id" value="${eleve.id}"/></c:url>' >
												<i class="entypo-menu"></i> affiche notes
										</a></li>
									</ul>
								</div>
							</td>
